  ...
  useEffect(() => {
    ...
    class App {
      constructor(container, options = {}) {
        ...
        this.isMobileDevice = window.innerWidth < 1024 || /Mobi|Android/i.test(navigator.userAgent);
        ...
        this.renderer = new THREE.WebGLRenderer({
          antialias: this.isMobileDevice ? true : false,
          alpha: true
        });
        this.renderer.setSize(initW, initH, false);
        this.renderer.setPixelRatio(Math.min(window.devicePixelRatio, this.isMobileDevice ? 1.2 : 1.5));
        ...
        // Visibility-based pause: stop rendering when scrolled off-screen
        this.paused = false;
        this.intersectionObserver = new IntersectionObserver(
          ([entry]) => {
            this.paused = !entry.isIntersecting;
            // Resume the clock so delta doesn't spike when unpausing
            if (!this.paused && this.clock) {
      ...
      tick() {
        ...
        // Skip all GPU work when scrolled out of view
        if (this.paused) {
